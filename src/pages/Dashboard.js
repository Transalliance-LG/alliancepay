    ...
    <div>
      ...
      <div className="py-[40px] xl:px-[150px] 2xl:px-[250px] lg:px-[30px] px-[5px] md:px-[10px]">
        <button
          ...
          className="rounded-[10px] bg-primary hover:bg-blue-800  text-white md:px-[18px] md:py-[12px] px-[12px] py-[8px] text-[12px] sm:text-[16px] flex justify-center mx-auto"
        >
          Privacy policy
        </button>
        {show ? (
